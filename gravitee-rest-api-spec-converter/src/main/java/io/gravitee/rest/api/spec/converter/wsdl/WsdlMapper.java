...
import io.gravitee.rest.api.spec.converter.OpenAPIMapper;
...
import static io.gravitee.rest.api.spec.converter.wsdl.WsdlMapperUtils.*;

/**
 * @author GraviteeSource Team
 */
public class WsdlMapper implements OpenAPIMapper {
    public static final Logger LOGGER = LoggerFactory.getLogger(WsdlMapper.class);
    ...
    private void processPorts(Service serviceDefinition) {
        ...
        while (portIterator.hasNext()) {
            ...
            for (int i = 0; i < binding.getBindingOperations().size(); ++i) {
                ...
                pathItem.post(openApiOperation); // TODO use the http:binding elment to extract the HTTP method (§4.4)
