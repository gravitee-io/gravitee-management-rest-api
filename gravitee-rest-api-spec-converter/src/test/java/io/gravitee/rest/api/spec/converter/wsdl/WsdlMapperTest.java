...
public class WsdlMapperTest {
    ...
    private WsdlMapper wsdlMapper = new WsdlMapper();
    ...
    public void convertWsdl() {
        ...
        OpenAPI openApi = wsdlMapper.toOpenAPI(this.getClass().getResourceAsStream(wsdl));
        ...
        for (PathItem path : paths.values()) {
            ...
            assertNotNull("Operation is required", operation);
            Map<String, Object> extensions = operation.getExtensions();
            if (extensions != null && extensions.keySet().contains(WsdlMapper.SOAP_EXTENSION_ENVELOPE)) {
                soapEnvelopes++;
            }
        }
