...
public class VirtualHostServiceTest {
    ...
    public void shouldSucceed_create_noApi() {
        ...
        virtualHostService.sanitizeAndValidate(Collections.singletonList(new VirtualHost("/context")), GraviteeContext.getCurrentEnvironment());
    }
    ...
    public void shouldFail_create_sameBasePath2() {
        ...
        virtualHostService.sanitizeAndValidate(Collections.singletonList(new VirtualHost("/context2")), GraviteeContext.getCurrentEnvironment());
    }
    ...
    public void shouldSucceed_create_sameVirtualHostAndSamePath() {
        ...
        virtualHostService.sanitizeAndValidate(Collections.singletonList(new VirtualHost("api.gravitee.io", "/context")), GraviteeContext.getCurrentEnvironment());
    }
    ...
    public void shouldSucceed_create_sameVirtualHostAndSameSubPath() {
        ...
        virtualHostService.sanitizeAndValidate(Collections.singletonList(new VirtualHost("api.gravitee.io", "/context/subpath")), GraviteeContext.getCurrentEnvironment());
    }
    ...
    public void validate_hostEqualsToDomainConstraint() {
        ...
        virtualHostService.sanitizeAndValidate(Collections.singletonList(vhost), GraviteeContext.getCurrentEnvironment());
    }
    ...
    public void validate_nullIsNotASubDomain() {
        ...
        final Collection<VirtualHost> virtualHosts = virtualHostService.sanitizeAndValidate(Collections.singletonList(vhost), GraviteeContext.getCurrentEnvironment());
