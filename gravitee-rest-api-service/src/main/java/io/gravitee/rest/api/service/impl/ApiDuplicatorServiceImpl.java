...
@Component
public class ApiDuplicatorServiceImpl extends AbstractApiService implements ApiDuplicatorService {
    ...
    public ApiEntity updateWithImportedDefinition(ApiEntity apiEntity, String apiDefinitionOrURL, String userId) {
        ...
        try {
            ...
            final JsonNode jsonNode = objectMapper.readTree(apiDefinition);
            UpdateApiEntity importedApi = convertToEntity(apiDefinition, jsonNode);
            ApiEntity updatedApiEntity = this.update(apiEntity.getId(), importedApi, false);
