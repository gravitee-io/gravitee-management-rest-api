...
public interface WsdlService {
    ...
    /**
     * Create an API from a WSDL descriptor. This method does not create an API but
     * extract data from WSDL to prepare an API to then create.
     *
     * @param wsdDescriptor Wsdl descriptor
     * @return The API from the Wsdl descriptor
     */
    SwaggerApiEntity createAPI(ImportWsdlDescriptorEntity wsdDescriptor);
