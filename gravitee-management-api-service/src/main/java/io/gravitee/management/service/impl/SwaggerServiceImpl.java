...
public class SwaggerServiceImpl implements SwaggerService {
    ...
    public SwaggerDescriptor parse(String content) {
        ...
        logger.info("Trying to load a Swagger v2 descriptor");
        ...
        logger.info("Trying to load an OpenAPI descriptor");
        ...
        logger.info("Trying to load an old Swagger descriptor");
