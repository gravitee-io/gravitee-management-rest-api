...
public class TokensResource extends AbstractResource  {
    ...
    @ApiResponse(responseCode = "200", description = "User's personal tokens",
            content = @Content(mediaType = MediaType.APPLICATION_JSON, array = @ArraySchema(schema = @Schema(implementation = TokenEntity.class))))
    ...
    @ApiResponse(responseCode = "201", description = "A new personal token",
