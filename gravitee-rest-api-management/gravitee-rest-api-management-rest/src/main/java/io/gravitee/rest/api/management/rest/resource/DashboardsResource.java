...
public class DashboardsResource extends AbstractResource  {
    ...
    @ApiResponse(responseCode = "200", description = "List of platform dashboards",
            content = @Content(mediaType = MediaType.APPLICATION_JSON, array = @ArraySchema(schema = @Schema(implementation = DashboardEntity.class))))
    ...
    @ApiResponse(responseCode = "200", description = "Platform dashboard",
            content = @Content(mediaType = MediaType.APPLICATION_JSON, schema = @Schema(implementation = DashboardEntity.class)))
    @ApiResponse(responseCode = "500", description = "Internal server error")
    @Permissions({
    ...
    @ApiResponse(responseCode = "200", description = "Updated dashboard",
            content = @Content(mediaType = MediaType.APPLICATION_JSON, schema = @Schema(implementation = DashboardEntity.class)))
    @ApiResponse(responseCode = "500", description = "Internal server error")
    @Permissions({
