...
public class FetcherResource {
    ...
    @ApiResponse(responseCode = "200", description = "Fetcher",
    ...
    @ApiResponse(responseCode = "200", description = "Fetcher's schema", content = @Content(mediaType = MediaType.APPLICATION_JSON))
    @ApiResponse(responseCode = "404", description = "Fetcher not found")
    @ApiResponse(responseCode = "500", description = "Internal server error")
