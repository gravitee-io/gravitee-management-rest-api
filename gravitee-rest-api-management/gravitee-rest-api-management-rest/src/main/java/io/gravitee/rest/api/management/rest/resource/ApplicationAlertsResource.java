...
public class ApplicationAlertsResource extends AbstractResource {
    ...
    @ApiResponse(responseCode = "500", description = "Internal server error")
    @Permissions({
            @Permission(value = APPLICATION_ALERT, acls = RolePermissionAction.CREATE)
    })
    ...
    @ApiResponse(responseCode = "500", description = "Internal server error")
    @Permissions({
            @Permission(value = APPLICATION_ALERT, acls = RolePermissionAction.UPDATE)
    })
    ...
    @ApiResponse(responseCode = "500", description = "Internal server error")
    @Permissions({
            @Permission(value = APPLICATION_ALERT, acls = RolePermissionAction.DELETE)
    })
