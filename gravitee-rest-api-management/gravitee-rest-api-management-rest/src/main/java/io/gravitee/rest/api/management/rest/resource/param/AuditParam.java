...
public class AuditParam {
    @QueryParam("envLog")
    @Parameter(description = "true if you only want logs from the current environment, false if you also want api, application and organization audit logs")
    private boolean environmentLogsOnly;

    @QueryParam("orgLog")
    @Parameter(description = "true if you only want logs from the current organization, false if you also want api, application and environment audit logs")
    ...
    @QueryParam("event")
    @Parameter(description = "filter by the name of an event.",
