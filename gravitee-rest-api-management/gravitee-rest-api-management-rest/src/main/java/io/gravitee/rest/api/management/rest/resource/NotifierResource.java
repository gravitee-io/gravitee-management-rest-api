...
public class NotifierResource {
    ...
    @ApiResponse(responseCode = "200", description = "Notifier plugin",
    ...
    @ApiResponse(responseCode = "200", description = "Notifier's schema", content = @Content(mediaType = MediaType.APPLICATION_JSON))
    @ApiResponse(responseCode = "404", description = "Notifier not found")
    @ApiResponse(responseCode = "500", description = "Internal server error")
    @Permissions({
            @Permission(value = RolePermission.ENVIRONMENT_API, acls = RolePermissionAction.READ)
