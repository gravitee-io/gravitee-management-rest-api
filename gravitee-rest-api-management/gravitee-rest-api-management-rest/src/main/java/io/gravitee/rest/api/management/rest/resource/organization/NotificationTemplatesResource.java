...
public class NotificationTemplatesResource extends AbstractResource {
    ...
    @ApiResponse(responseCode = "200", description = "Notifications templates",
            content = @Content(mediaType = io.gravitee.common.http.MediaType.APPLICATION_JSON, array = @ArraySchema(schema = @Schema(implementation = NotificationTemplateEntity.class))))
    ...
    public Response getNotificationTemplates(
            @Parameter(description = "filter by notification scope")
            @QueryParam("scope") String scope,
            @Parameter(description = "filter by notification hook")
    ...
    @ApiResponse(responseCode = "200", description = "Created notification template",
            content = @Content(mediaType = io.gravitee.common.http.MediaType.APPLICATION_JSON, schema = @Schema(implementation = NotificationTemplateEntity.class)))
    ...
    @ApiResponse(responseCode = "200", description = "Notification template found",
            content = @Content(mediaType = io.gravitee.common.http.MediaType.APPLICATION_JSON, schema = @Schema(implementation = NotificationTemplateEntity.class)))
    ...
    public Response getNotificationTemplate(
            @Parameter(description = "ID of the notification template")
    ...
    @ApiResponse(responseCode = "200", description = "Updated notification template",
            content = @Content(mediaType = io.gravitee.common.http.MediaType.APPLICATION_JSON, schema = @Schema(implementation = NotificationTemplateEntity.class)))
