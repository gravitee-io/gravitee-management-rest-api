...
public class FetchersResource {
    ...
    @ApiResponse(responseCode = "200", description = "List of fetchers",
            content = @Content(mediaType = MediaType.APPLICATION_JSON, array = @ArraySchema(schema = @Schema(implementation = FetcherListItem.class))))
