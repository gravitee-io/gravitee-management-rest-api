...
@Profile("basic")
@EnableWebSecurity
public class BasicSecurityPortalConfigurerAdapter extends WebSecurityConfigurerAdapter {

    private static final Logger LOGGER = LoggerFactory.getLogger(BasicSecurityPortalConfigurerAdapter.class);
