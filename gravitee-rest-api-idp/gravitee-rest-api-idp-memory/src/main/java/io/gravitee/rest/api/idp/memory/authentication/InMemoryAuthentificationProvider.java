...
public class InMemoryAuthentificationProvider extends AbstractUserDetailsAuthenticationProvider
    ...
    protected UserDetails retrieveUser(String username, UsernamePasswordAuthenticationToken authentication) throws AuthenticationException {
        ...
        io.gravitee.rest.api.idp.api.authentication.UserDetails grUserDetails =
                new io.gravitee.rest.api.idp.api.authentication.UserDetails(userDetails.getUsername(), userDetails.getPassword(), userDetails.getAuthorities());
