...
public final class JettyEmbeddedContainer extends AbstractLifecycleComponent<JettyEmbeddedContainer> implements ApplicationContextAware {
    ...
    protected void doStart() throws Exception {
        ...
        ServletContextHandler portalContextHandler = configureAPI(entrypoint+"portal", GraviteePortalApplication.class.getName(), SecurityPortalConfiguration.class);
        
        // REST configuration for Management API
        ServletContextHandler managementContextHandler = configureAPI(entrypoint+"management", GraviteeManagementApplication.class.getName(), SecurityManagementConfiguration.class);
        
        server.setHandler(new ContextHandlerCollection(portalContextHandler, managementContextHandler));
        // start the server
        server.start();
    }
